      ...
      <div className="row">
        <div className="col-lg-6 white-text vertical-center">
          <div className="AMborder">
            <p className="uplouad-paragraph">Upload an image</p>
            <FileUpload
            ...
            />
            {value ? (
              <p className="file-paragraph text-center">{value[0].name}</p>
            ) : (
              <p className="file-paragraph text-center">
                <br />
              </p>
            )}
            <button href="# " className="AIbutton justify-content-center ">
              Start analyzing
            </button>
          </div>
        </div>
